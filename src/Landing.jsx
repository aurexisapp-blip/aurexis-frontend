...
export default function Landing({ onGetStarted }) {
  const PRICING_PLANS = [
    ...
    },
    {
      ...
      features: [
        ["✓","3 picks/week — symbol, direction & AI score"],
        ["✓","Edge signals"],
        ["✓","\"Why This Trade\" reasoning"],
        ["✓","AI \"What This Means\" metrics explainer"],
        ["✓","AI news & sentiment summary"],
        ["✓","Top Movers (full, unlimited)"],
        ["✓","Watchlist, journal & performance tracking"],
        ["✓","Email alerts — new picks & outcomes"],
        ["—","Full trade plan — entry, stop & targets"],
        ["—","Unlimited daily AI picks"],
    ...
    },
    {
      ...
      features: [
        ...
        ["✓","Full trade plan — entry, stop & Fibonacci targets"],
        ["✓","Unlimited daily AI picks"],
